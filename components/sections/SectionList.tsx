              ...
              >
                {(provided) => (
                  <div
                    ...
                    className="flex items-center bg-[#FFF8EB] text-sm p-3 font-medium rounded-lg"
                  >
                    <div className="" {...provided.dragHandleProps}>
                      <Grip className="size-4 cursor-pointer mr-4 hover:text-[#FDAB04]" />
                    </div>
                    {section.title}
                    <div className="ml-auto">
                      <Pencil
                        className="size-4 cursor-pointer hover:text-[#FDAB04]"
